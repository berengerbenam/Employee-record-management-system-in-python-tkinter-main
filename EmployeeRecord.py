...
import os
root=Tk()
root.title('Employee record for Berenger')
...
#=====================Heading=======================
title=Label(root,text='Employee Records System Berenger',bg=bg_color,fg='white',font=('times new rommon',35,'bold'),relief=GROOVE,bd=12)
title.pack(fill=X)
